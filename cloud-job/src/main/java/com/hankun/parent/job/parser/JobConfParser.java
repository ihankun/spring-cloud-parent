package com.hankun.parent.job.parser;

import com.alibaba.cloud.nacos.NacosDiscoveryProperties;
import com.dangdang.ddframe.job.api.ElasticJob;
import com.hankun.parent.commons.utils.SpringHelpers;
import com.hankun.parent.job.annotation.KunJobConf;
import com.hankun.parent.job.base.JobAttributeTag;
import com.hankun.parent.job.dynamic.bean.Job;
import com.hankun.parent.job.dynamic.service.JobService;
import com.hankun.parent.job.strategy.ServerListHolder;
...
public class JobConfParser implements ApplicationContextAware {
    ...
    @Resource
    private SpringHelpers springHelpers;
    ...
    public void init() throws BeansException, NoSuchFieldException, IllegalAccessException {
        ...
        Map<String, Object> beanMap = context.getBeansWithAnnotation(KunJobConf.class);

        for (Map.Entry<String, Object> confBean : beanMap.entrySet()) {

            Class<?> clz = confBean.getValue().getClass();
            KunJobConf conf = AnnotationUtils.findAnnotation(clz, KunJobConf.class);
     ...
     */
    private void initMoreItemJobAttribute(Object jobBean, KunJobConf conf) throws NoSuchFieldException,
