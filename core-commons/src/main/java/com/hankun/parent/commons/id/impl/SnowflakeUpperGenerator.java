 ...
 * @author hankun
 */
public class SnowflakeUpperGenerator implements IdGeneratorInterface {
    /**
     * 业务线标识id所占的位数
     **/
    ...
    public SnowflakeUpperGenerator(long serviceId) {
     ...
     */
    protected long getWorkerId() throws RuntimeException {
        try {
    ...
    public static void main(String[] args) {
        SnowflakeUpperGenerator generator = new SnowflakeUpperGenerator(255);
        SnowflakeUpperGenerator generato2 = new SnowflakeUpperGenerator(0);
        SnowflakeUpperGenerator generato3 = new SnowflakeUpperGenerator(3);

        int loop = 100;
        for (int i = 0; i < loop; i++) {
            long l = generator.nextId();
            long l1 = generato2.nextId();
            long l2 = generato3.nextId();
