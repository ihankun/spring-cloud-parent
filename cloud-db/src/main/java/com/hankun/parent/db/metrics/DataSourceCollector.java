...
public class DataSourceCollector {
    ...
    public DataSourceCollector(MeterRegistry registry) {
        this.registry = registry;
    }

    void register(List<DynamicRoutingDataSource> list){
        list.forEach((dynamicRoutingDataSources) ->{
            Map<String, DataSource> currentDataSources = dynamicRoutingDataSources.getCurrentDataSources();
            currentDataSources.forEach((k,dataSource)->{
                if(dataSource instanceof ItemDataSource){
                    ...
                    if(realDataSource instanceof DruidDataSource){
                        ...
                        datasourceRegister(druidDataSource);
                        return;
                    }
                }
    ...
    void datasourceRegister(DruidDataSource druidDataSource){
