package com.hankun.parent.mq.rocketmq.producer.strategy;
...
public class KunProdStrategy extends MQFaultStrategy {
    ...
    private final int graySize;

    public KunProdStrategy(int graySize) {
    ...
    public MessageQueue selectOneMessageQueue(TopicPublishInfo tpInfo, String lastBrokerName) {
        ...
        List<MessageQueue> prodMessageQueueList =  tpInfo.getMessageQueueList().subList(graySize, tpInfo.getMessageQueueList().size());
